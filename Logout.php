                        ...
                        <p class="mb-4">
                          ...
                          <?php
                            if (isset($_SESSION['username'])){
                              ...
                              session_destroy();      
                              echo "<p style='line-height: normal;'><h1>You have been logged out.</h1><br></p><script type='text/javascript'>window.setTimeout(function() {
                                  window.location.href='index.php';
                                  }, 3000); </script>";
                          }else{
                              echo "<p style='line-height: normal;'><h1>You are not logged in. Please log in. </h1></p><script type='text/javascript'>window.setTimeout(function() {
