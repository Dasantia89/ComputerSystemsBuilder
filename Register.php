...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <title>Computer Systems Builder - Register</title>
    <!-- Importing fonts -->
    <!-- Source Sans Pro -->
...
<center><div style = "margin-bottom: 30px;"><br><br><br><br><br><br><br>
...
echo '<br>';
echo '<form  method="post" action="php/RegistrationCheck.php"  enctype="multipart/form-data" onsubmit="return validate(this)">
...
<br><h4>Username must be at least 5 characters long.</h4><br><h4>Password must be at least 5 characters long and requires one capital letter and one number.</h4>
</div></center>';
