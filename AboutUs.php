...
<body id="body">
    ...
    <center>
      ...
      <br>
      <p class="mb-4">Here at Team CSB we put you first. Our goal is to streamline
      the computer building</p>
      <p class="mb-4">process by providing our users with a hub designed to locate computer components.</p>
      <p class="mb-4">Starting as a college project, CSBuilder.me has grown into a fully-viable resource</p>
      <p class="mb-4">for people across the world. We have a dedicated team of 5 developers, allowing us to</p>
      <p class="mb-4">create developments as a close-knit group, which improves communication and productivity.</p>
    </center>
