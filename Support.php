...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <title>Computer Systems Builder - Support</title>
    <!-- Importing fonts -->
    <!-- Source Sans Pro -->
...
<body id="body">
   ...
   <header>
    ...
    <section class="section" style="padding-top: 200px;">
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-align:center mb-5 mb-md-0">
                    <img src="images/aboutuscolabpic.jpg" alt="collab" style="max-width: 80%;">
                </div>
                <div class="col-md-6 align-self-center text-center text-md-left">
                    <div class="block">
                        <h1 class="font-weight-bold mb-4 font-size-60">Support</h1>
                        <p class="mb-4">We here at CSB know how important your computer is to you. That's why we wanted to create a system that would allow extensive customization of your PC, making it your very own. We also figured we'd have prebuilts to offer, as many corporations would be intrigued of purchasing in bulk. If any complications arise, feel free to contact us via the button below, opening a ticket for us to review. Also below, is a download link to our system specification viewer. You can download and run the .exe to view your system specifications such as ip address, CPU, GPU, RAM, network bandwidth and the OS.  </p>
                       
                        <!-- Sends the user to the create ticket form -->
     <pre><form method="post" action="php/CreateTicket.php" >
              <input type = "submit" class="btn btn-main" value="Open a Ticket"></form>       <form action="php/CreateTicket.php"></form><form  method="get" action="Team_CSB_Spec_Viewer.zip"><input class="btn btn-main" type="submit" value="Download"></form></pre>
